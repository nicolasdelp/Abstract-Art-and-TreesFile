...
public class Main {
    ...
    private final static int nbFeuilles = 12; // Le nombre de feuilles maximum de l’arbre
    ...
    private final static double memeCouleurProb = 0.4; // La probabilité de garder la couleur du parent
